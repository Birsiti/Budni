...
var MINSK_RAION = ['Колодищи', 'Боровляны', 'Мачулищи', 'Озерцо', 'Валерьяново',
  'Ждановичи', 'Привольный', 'Привольное', 'Королёв Стан', 'Большой Тростенец',
  'Михановичи', 'Острошицкий Городок', 'Ратомка', 'Большевик', 'Лесковка',
  'Сеница', 'Крупица', 'Прилесье', 'Тарасово', 'Луговая Слобода',
  'Новая Боровая', 'Богатырево', 'Ярково', 'Семково', 'Юзуфово', 'Гатово',
  'Прилуки', 'Щомыслица', 'Цнянка'];
...
var BREST_OBLAST = ['Барановичи', 'Белоозерск', 'Берёза', 'Брест', 'Высокое',
  'Ганцевичи', 'Дрогичин', 'Жабинка', 'Иваново', 'Ивацевичи', 'Каменец',
  'Кобрин', 'Лунинец', 'Ляховичи', 'Малорита', 'Микашевичи', 'Пинск',
  'Пружаны', 'Ружаны', 'Столин'];
var VITEBSK_OBLAST = ['Болбасово', 'Браслав', 'Витебск', 'Глубокое', 'Городок',
  'Докшицы', 'Дубровно', 'Лепель', 'Новолукомль', 'Новополоцк', 'Орша',
  'Полоцк', 'Поставы', 'Сенно', 'Ушачи', 'Шумилино'];
var GOMEL_OBLAST = ['Буда-Кошелёво', 'Ветка', 'Гомель', 'Добруш', 'Ельск',
  'Житковичи', 'Жлобин', 'Калинковичи', 'Лельчицы', 'Мозырь', 'Речица',
  'Рогачёв', 'Светлогорск', 'Хойники', 'Чечерск'];
var GRODNO_OBLAST = ['Большая Берестовица', 'Волковыск', 'Вороново', 'Гродно',
  'Дятлово', 'Зельва', 'Ивье', 'Кореличи', 'Лида', 'Новогрудок', 'Островец',
  'Ошмяны', 'Скидель', 'Слоним', 'Сморгонь', 'Щучин'];
var MINSK_OBLAST = ['Березино', 'Борисов', 'Великий Камень', 'Воложин',
  'Дзержинск', 'Жодино', 'Заславль', 'Логойск', 'Любань', 'Марьина Горка',
  'Молодечно', 'Мядель', 'Нарочь', 'Несвиж', 'Радошковичи', 'Слуцк',
  'Смиловичи', 'Смолевичи', 'Солигорск', 'Старые Дороги', 'Столбцы', 'Узда',
  'Фаниполь', 'Червень'];
var MOGILEV_OBLAST = ['Белыничи', 'Бобруйск', 'Горки', 'Кировск', 'Климовичи',
  'Кличев', 'Костюковичи', 'Краснополье', 'Кричев', 'Могилёв', 'Мстиславль',
  'Осиповичи', 'Славгород', 'Чаусы', 'Шклов'];
