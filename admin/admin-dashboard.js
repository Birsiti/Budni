...
// Список сверен с Денисом 2026-09-14, дополнен 2026-09-20 (Гатово, Прилуки,
// Щомыслица, Цнянка, Привольное — тоже агрогородки/посёлки Минского района,
// не самого города), дополнять по мере находок. "Коммунарка" сюда НЕ входит,
// хотя под Минском есть тёзка — Денис 2026-09-14 уже отнёс это название к
// RF_CITIES (Коммунарка/Новая Москва), не переопределяем тихо.
// 2026-09-20, второй заход: сверился с реальными значениями city в проде
// (225 уникальных строк) — добавлены опечатки/варианты написания без ё и
// с большой буквы ("Королев Стан", "Мачулиши", "Аг.ждановичи", "Минский
// Район" — сама метка района, разворачивается в эту же группу) и найденные
// агрогородки/сельсоветы Минского района (Хатежинский с/с, Папернянский
// сельсовет, Самохваловичи).
var MINSK_RAION = ['Колодищи', 'Боровляны', 'Мачулищи', 'Мачулиши', 'Озерцо',
  'Валерьяново', 'Ждановичи', 'Аг.ждановичи', 'Привольный', 'Привольное',
  'Королёв Стан', 'Королев Стан', 'Большой Тростенец', 'Михановичи',
  'Острошицкий Городок', 'Ратомка', 'Большевик', 'Лесковка', 'Сеница',
  'Крупица', 'Прилесье', 'Тарасово', 'Луговая Слобода', 'Новая Боровая',
  'Богатырево', 'Ярково', 'Семково', 'Юзуфово', 'Гатово', 'Прилуки',
  'Щомыслица', 'Цнянка', 'Минский Район', 'Хатежинский С/с',
  'Папернянский Сельсовет', 'Самохваловичи', 'Лесной'];

// города/посёлки России — сверено с Денисом 2026-09-14 (Подмосковье — тоже сюда),
// Алдан/Ковров дополнены 2026-09-17. "Королёв" (Моск. обл.) — не путать с
// "Королёв Стан" (Минский район) выше. "Королево"/"Ковры" — опечатки в
// реальных данных (2026-09-20), тот же смысл, что "Королёв"/"Ковров".
var RF_CITIES = ['Москва', 'Санкт-петербург', 'Дмитров', 'Солнечногорск', 'Яхрома',
  ...
  'Кимры', 'Королёв', 'Королево', 'Красногорск', 'Мурманск', 'Нижний Новгород',
  'Подмосковье', 'Подольск', 'Ростов-на-дону', 'Чехов', 'Пересвет',
  'Сосновый Бор', 'Коммунарка', 'Алдан', 'Ковров', 'Ковры'];
...
// "Д. Копище" (2026-09-20) — тот же вариант с приставкой "Д." в реальных
// данных, не путать с "Лошница" (агрогородок в Борисовском районе,
// Минская область — см. MINSK_OBLAST) — созвучно с "Лошица", но другое место.
var MINSK_DISTRICTS_GROUP = ['Шабаны', 'Уручье', 'Каменная Горка', 'Лошица',
  'Сухарево', 'Копище', 'Д. Копище', 'Колядичи', 'Чижовка'];

// 6 областей РБ по районным центрам/крупным нас.пунктам — синхронизировано
// с OBLAST_CITIES в api/format.py (та же карта нужна была для public_stats,
// 2026-09-20). Минский район сюда НЕ входит — он уже своя группа выше,
// не задваиваем спутники Минска между двумя группами.
// Второй заход 2026-09-20 по реальным данным прод-БД: добавлены опечатки
// без ё ("Береза", "Рогачев", "Могилев", "Смогонь"→Сморгонь) и районные
// центры/агрогородки, которых не было в BY_CITIES (подсказки формы —
// не то же самое, что полный список того, что реально прислал GPT).
var BREST_OBLAST = ['Барановичи', 'Белоозерск', 'Берёза', 'Береза', 'Брест',
  'Высокое', 'Ганцевичи', 'Домачево', 'Дрогичин', 'Жабинка', 'Иваново',
  'Ивацевичи', 'Каменец', 'Кобрин', 'Коссово', 'Лунинец', 'Ляховичи',
  'Малорита', 'Микашевичи', 'Пинск', 'Пружаны', 'Ружаны', 'Столин'];
var VITEBSK_OBLAST = ['Барань', 'Бешенковичи', 'Болбасово', 'Д. Болбасово',
  'Браслав', 'Верхнедвинск', 'Витебск', 'Глубокое', 'Городок', 'Дисна',
  'Докшицы', 'Дубровно', 'Лепель', 'Лиозно', 'Миоры', 'Новолукомль',
  'Новополоцк', 'Орша', 'Полоцк', 'Поставы', 'Россоны', 'Сенно', 'Толочин',
  'Ушачи', 'Шарковщина', 'Шумилино'];
var GOMEL_OBLAST = ['Буда-Кошелёво', 'Буда-кошелево', 'Ветка', 'Гомель',
  'Добруш', 'Ельск', 'Житковичи', 'Жлобин', 'Калинковичи', 'Копаткевичи',
  'Корма', 'Лельчицы', 'Мозырь', 'Октябрьский', 'Петриков', 'Речица',
  'Рогачёв', 'Рогачев', 'Светлогорск', 'Туров', 'Хойники', 'Чечерск'];
var GRODNO_OBLAST = ['Большая Берестовица', 'Волковыск', 'Вороново', 'Гродно',
  'Дятлово', 'Зельва', 'Ивье', 'Кореличи', 'Лида', 'Мосты', 'Новогрудок',
  'Островец', 'Ошмяны', 'Скидель', 'Слоним', 'Сморгонь', 'Смогонь', 'Свислочь',
  'Щучин'];
var MINSK_OBLAST = ['Березино', 'Борисов', 'Великий Камень', 'Вилейка',
  'Воложин', 'Дзержинск', 'Жодино', 'Заславль', 'Клецк', 'Копыль', 'Логойск',
  'Лошница', 'Любань', 'Марьина Горка', 'Минская Область', 'Молодечно',
  'Мядель', 'Нарочь', 'Несвиж', 'Пуховичский Район', 'Радошковичи', 'Слуцк',
  'Смиловичи', 'Смолевичи', 'Солигорск', 'Старые Дороги', 'Столбцы', 'Узда',
  'Фаниполь', 'Червень'];
var MOGILEV_OBLAST = ['Белыничи', 'Бобруйск', 'Быхов', 'Горки', 'Кировск',
  'Климовичи', 'Кличев', 'Костюковичи', 'Краснополье', 'Кричев', 'Могилёв',
  'Могилев', 'Мстиславль', 'Осиповичи', 'Славгород', 'Чаусы', 'Шклов'];
...
// 2026-09-20 (по просьбе Дениса): весь список разнесён по областям РБ + РФ,
// вместо трёх групп-исключений и кучи плоских строк вперемешку. Минск и
// Минский район — отдельные пункты (не путать с «Минская область»).
var CITY_GROUPS = [
  { key: 'minsk', name: 'Минск', cities: MINSK_DISTRICTS_GROUP },
  { key: 'raion', name: 'Минский район', cities: MINSK_RAION },
  { key: 'brest', name: 'Брестская область', cities: BREST_OBLAST },
  { key: 'vitebsk', name: 'Витебская область', cities: VITEBSK_OBLAST },
  { key: 'gomel', name: 'Гомельская область', cities: GOMEL_OBLAST },
  { key: 'grodno', name: 'Гродненская область', cities: GRODNO_OBLAST },
  { key: 'minskobl', name: 'Минская область', cities: MINSK_OBLAST },
  { key: 'mogilev', name: 'Могилёвская область', cities: MOGILEV_OBLAST },
